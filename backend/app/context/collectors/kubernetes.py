...
class KubernetesCollector:
    ...
    def collect(self, db, environment, connection):
        ...
        try:
            ...
            result = self.transport.execute(connection, environment, ["kubectl", "-n", namespace, "get", "deployments,services", "-o", "json"])
            ...
            run.status = "success"; run.summary_json = {"entities": len(services) + len(deployments), "relationships": relationships, "namespace": namespace}
